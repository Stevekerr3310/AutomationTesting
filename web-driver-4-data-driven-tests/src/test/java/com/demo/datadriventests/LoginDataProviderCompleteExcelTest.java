package com.demo.datadriventests;
...
public class LoginDataProviderCompleteExcelTest {
	...
	//Create the Data and give the data provider a name
	@DataProvider(name="user-ids-passwords-excel-data-provider")
	public Object[][] usesIdsAndPasswordsDataProvider() {
		return ExcelReadUtil.readExcelInto2DArray("./src/test/resources/login-data.xlsx", "工作表1", 3);
	}
	...
	public void readFromExcel() {
		//[[in28minutes, dummy, true], [adam, adam, false], [adam, adam@123, true],
		//[eve, eve, false], [eve, eve@123, true]]
		String[][] data = ExcelReadUtil.readExcelInto2DArray("./src/test/resources/login-data.xlsx", "工作表1", 3);
